...
Usage: python3 tool/run_study_flutter_smoke.py EXTERNAL_PUBLIC_CONFIG [--accounts EXTERNAL_JSON] [--device UUID]
"""
import argparse
import getpass
import json
...
def main():
    ...
    if args.accounts:
        ...
        if not sys.stdin.isatty():
            raise ValueError("Interactive terminal required for hidden passwords")
